...
function inArray(a,b){for(var c=b.length,d=0;d<c;d++)if(b[d]==a)return!0;return!1}
// ------ ** ------ 
...
function vp_load(a,b,c){var d=a.getAttribute("id"),e=g_site_url+"/home/app_data.php?oper=get-gallery&jsoncallback=handleStuff",f="&obj_type="+b.obj_type+"&id="+b.id+"&share_id="+b.share_id+"&target="+d;console.log("vpload on el: "+d),
// console.log("Calling ajax_url:" + ajax_url + data_str + " el: " + cid);
$jsonp.send(e+f,{callbackName:"handleStuff",onSuccess:function(a){
//console.log('success!', json);
var d=a.target,e=document.getElementById(d),f=e.className,g=f.replace(/transparent/,"");console.log("success Id: "+d+" json: ",a),
//console.log("success Id: " + cid + " Changing class from " + cn + " => " + ncn);
e.className=g;var h,i,j,k,l=[];if(g_user_id=a.user_id,g_user_id){g_follow=[];var m=a.follow;for(h=0;h<m.length;h++){var n=m[h];g_follow[n]=1}}j=a.items;for(h in j)i=j[h],k={},k.src=i.href,k.w=i.w,k.h=i.h,k.title=i.title,k.data=i,l.push(k);var o={};o.html='<iframe width="100%" height="100%" src="'+g_site_url+'/login/?_aid=100"></iframe>';
//psitems.push(iframe);
// define options (if needed)
document.querySelectorAll(".pswp")[0];
// var gallery = new PhotoSwipe(element, PhotoSwipeUI_Default, psitems, options);
e.setAttribute("data-pswp-uid",d),e.onclick=onThumbnailsClick,
// Initializes and opens PhotoSwipe
// var gallery = new PhotoSwipe( pswpElement, PhotoSwipeUI_Default, items, options);
a.psitems=l,a.element=e,a.data=b,console.log("g_list for cid="+d+" and user:"+g_user_id+" = ",a),g_list[d]=a,c&&g_pswp?(g_cid=d,g_pswp.items=l,
// sets a flag that slides should be updated
g_pswp.invalidateCurrItems(),
// updates the content of slides
g_pswp.updateSize(!0),g_user_id?userBtn.style.display="block":userBtn.style.display="none"):console.log("Not Reloading")},onTimeout:function(){console.log("load timeout!")},timeout:5})}/** Reload gallery data and redraw PhotoSwipe */
function reloadPhotoswipe(a,b,c,d,e){var f=g_list[a];g_cid=a,items=f.psitems,console.log("Reloading ps cid="+a+" index="+b),vp_load(f.element,f.data,!0)}!function(a,b){"function"==typeof define&&define.amd?define(b):"object"==typeof exports?module.exports=b():a.PhotoSwipe=b()}(this,function(){"use strict";var a=function(a,b,c,d){/*>>framework-bridge*/
/**
 *
...
// Buttons/elements
closeEl:!0,captionEl:!0,fullscreenEl:!0,zoomEl:!0,shareEl:!0,counterEl:!0,arrowEl:!0,preloaderEl:!0,
// new buttons
likeEl:!0,chatEl:!0,infoEl:!0,userEl:!0,
...
// 
return"http://test.vpatina.com/user/17426/vault/1130/title_image/image/big/deathtostock_clementine4.jpg"},getPageURLForShare:function(a){return window.location.href},getTextForShare:function(a){return"The Title"},
// Parse output of share links
parseShareButtonOut:function(a,b){
// `shareButtonData` - object from shareButtons array
// `shareButtonOut` - raw string of share link element
return b}},e)if(g.galleryPIDs){
// parse real index when custom PIDs are used
// http://photoswipe.com/documentation/faq.html#custom-pid-in-url
for(var k=0;k<h.length;k++)if(h[k].pid==b){g.index=k;break}}else
// in URL indexes start from 1
g.index=parseInt(b,10)-1;else g.index=parseInt(b,10);
// exit if index not found
if(!isNaN(g.index)){d&&(g.showAnimationDuration=0),console.log("Start PS with options:",g),
// Pass data to PhotoSwipe and initialize it
f=new PhotoSwipe(i,PhotoSwipeUI_Default,h,g),f.init(),g_pswp=f;var l=document.getElementById("myModal"),m=document.getElementById("chatBtn"),n=document.getElementById("closeBtn"),o=document.getElementById("likeBtn");
// When the user clicks the button, open the modal
m.onclick=function(){l.style.display="block"},n.onclick=function(){l.style.display="none",console.log("click on chatBtn"),reloadPhotoswipe(a,b,c,d,e)},
// When the user clicks the button, open the modal
o.onclick=function(){console.log("click on like");var b=g_pswp.getCurrentData(a);console.log("data=",b),g_user_id?(console.log("click on like by user"),g_pswp.like(a,b)):console.log("click on like - no user")};var p=document.getElementById("userBtn");g_user_id?p.style.display="block":p.style.display="none",g_pswp.listen("afterChange",function(b){var c=g_pswp.getCurrentData(a);console.log("gcd for cid="+a+" returned ",c);var d=c.item,e=d.original_price,f=d.original_height,g=d.original_width,h=d.original_technique,i=d.original_currency,j=d.title,k=d.media_id,l=j+" "+h+" ("+f+"x"+g+") "+e+" "+i;console.log("Slide changed: index="+g_pswp_index+" str="+l+" mid="+k);
//console.log(psitem);
//alert(str);
var m=g_user_id&&g_follow.length&&g_follow[k];// inArray(mid, g_follow);
console.log("Reload is true mid="+k+" user_id="+g_user_id+" follow len="+g_follow.length+" follow="+m);var n=document.getElementById("likeBtn"),o=m?'<i class="fa fa-star"></i>':'<i class="fa fa-star-o"></i>';n.innerHTML=o}),g_pswp.like=function(a,b){var c=g_site_url+"/home/app_data.php?oper=gallery-favorite&format=json&jsoncallback=likeStuff";
//$('#galleria .galleria-stage').addClass("loading-big");
console.log("like: data=",b);var d=b.item,e=d.media_id,f="&site_id="+vpata.site_id+"&user_id="+b.user_id+"&obj_type="+b.obj_type+"&obj_id="+e+"&share_id="+b.share_id+"&target="+a;console.log("like: url=",c);var g=document.getElementById("likeBtn"),h='<i class="fa fa-spinner fa-spin"></i>';g.innerHTML=h,$jsonp.send(c+f,{callbackName:"likeStuff",onSuccess:function(a){console.log("like success:",a);var b=a.id,c=b?'<i class="fa fa-star"></i>':'<i class="fa fa-star-o"></i>';
//console.log("follow was:", json);
g_follow[e]=b,g.innerHTML=c},onTimeout:function(){console.log("like timeout!")},timeout:5})},g_pswp.getCurrentData=function(a){var b=this.getCurrentIndex(),c=g_list[a],d=c,e=c.psitems,f=e[b];return d.index=b,d.item=f.data,console.log("get current data for cid="+a+" index="+b+" data:",d),d}}},onThumbnailsClick=function(a){a=a||window.event,a.preventDefault?a.preventDefault():a.returnValue=!1;var b=a.target||a.srcElement,c=closest(b,function(a){return a.tagName&&"FIGURE"===a.tagName.toUpperCase()}),d=c.getAttribute("data-pswp-uid");console.log("onThumbnailsClick: cid="+d);
//console.log("onThumbnailsClick: cid=" + cid + " e:", e, " target:", eTarget, " item:", clickedListItem);
var e=0;return void openPhotoSwipe(d,e,c);
// find index of clicked item by looping through all child nodes
// alternatively, you may define index via data- attribute
var e},vpElements=document.querySelectorAll(".vp-loader-photoswipe"),len=vpElements.length,i=0;i<len;i++){var vpElement=vpElements[i],data=vpElement&&vpElement.getAttribute("data-search");data=JSON.parse(data),vp_load(vpElement,data,!1)}